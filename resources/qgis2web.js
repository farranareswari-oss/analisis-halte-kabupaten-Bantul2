...
map.getView().fit([12253951.099855, -896021.248408, 12324036.112452, -865056.268552], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analisis Halte Kabupaten Bantul</h2>';
        return titleElement;
    })(),
